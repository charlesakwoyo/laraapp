    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @guest
            <div class="pt-4 pb-1 border-t border-gray-200 space-y-2 px-4">
                <a href="{{ route('login') }}" class="block text-gray-700 hover:text-gray-900 font-medium">
                    {{ __('Login') }}
                </a>
                <a href="{{ route('register') }}" class="block bg-blue-600 text-white text-center px-4 py-2 rounded-md hover:bg-blue-700">
                    {{ __('Register') }}
                </a>
            </div>
        @else
